...
{
    public class PGSAPSReportRepository : ISAPSReportRepository
    {
        ...
        private string GetTotalAppointmentsQuery = @"select count(*) from appointmentsheet where assignedsalesagent = :userid OR creator = :userid AND createdat BETWEEN :startdate AND :enddate";
        private string GetTotalAccountsQuery = @"select count(*) from account where aacreator = :userid OR assignedsalesrep = :userid AND accountapprovaldate BETWEEN :startdate AND :enddate";
        ...
        private string GetTotalClosesQuery = @"select count(distinct parentlead) from account where aacreator = :userid OR assignedsalesrep = :userid AND accountapprovaldate BETWEEN :startdate AND :enddate";
        private string GetTotalGoodAppointmentsQuery = @"select count(*) from appointmentsheet where creator = :userid OR assignedsalesagent = :userid AND score = 'Good' AND createdat BETWEEN :startdate AND :enddate";
        #endregion
