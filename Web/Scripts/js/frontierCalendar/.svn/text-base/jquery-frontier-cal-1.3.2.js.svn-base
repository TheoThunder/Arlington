...
(function ($) {
    ...
    */
    function CalendarAgendaItem(title, zone, salesAgent, startDate, endDate, allDay, hashData) {
        ...
        this.zoneValue = zone;
        // Sales Agenda
        this.salesAgentValue = salesAgent;
        // start date & time
        ...
        */
        ...
        this.getsalesAgent = function () {
            return this.salesAgentValue;
        };
        /**
        ...
        */
        this.toString = function () {
            ...
            s += "Zone:" + this.zoneValue + "\n";
            s += "Sales Agent:" + this.salesAgentValue + "\n";
        ...
        this.renderSingleAgendaItem = function (agi) {
            ...
            if ((DateUtil.daysDifference(firstRenderDate, lastRenderDate) + firstDtIndex) > 6) {
                ...
                if (agi.isAllDay()) {
                    ...
                    displayMessage = DateUtil.getAgendaDisplayTime(agi.getStartDate()) + " " + agi.getTitle() + "<br> Zone: " + agi.getZone() + " <br> Sales Agent:" + agi.getsalesAgent();
                }
                ...
                if (agi.isAllDay()) {
                    // don't show start time
                    displayMessage = agi.getTitle();
                    displayMessage = agi.getZone();
                    displayMessage = agi.getsalesAgent();
                } else {
                    displayMessage = DateUtil.getAgendaDisplayTime(agi.getStartDate()) + " " + agi.getTitle() + "<br> Zone: " + agi.getZone() + "<br>SAgent: " + agi.getsalesAgent() + "<br>";
                }
                isBegining = ((DateUtil.daysDifferenceDirection(agendaStartDate, firstRenderDate) == 0) ? true : false);
                isEnd = ((DateUtil.daysDifferenceDirection(agendaEndDate, lastRenderDate) == 0) ? true : false);
                this.renderAgendaDivElement(
    ...
    */
    Calendar.buildUserAgendaObject = function (agendaObject) {
        ...
        var agendaData = {
            ...
            zone: agendaObject.getZone(),
            salesAgent: agendaObject.getsalesAgent(),
    ...
    */
    Calendar.showMoreAgendaModal = function (cal, date, agendaItems) {
        ...
        for (var i = 0; i < agendaItems.length; i++) {
            ...
            agendaDiv.append(agi.getTitle() + "<br>Zone: " + agi.getZone() + "<br>Sales Agent: " + agi.getsalesAgent() + "<br>");
            if (agi.isAllDay()) {
                // don't show start time
    ...
    */
    var jFrontierCalPlugin = function (
        ...
        *
        */
        this.addAgendaItem = function (calId, title, zone, salesAgent, startDate, endDate, allDay, data, displayProp) {
            if (calId != null && title != null && startDate != null && endDate != null && allDay != null) {
                ...
                var agi = new CalendarAgendaItem(title, zone, salesAgent, startDate, endDate, allDay, hashData);
                if (displayProp != null) {
