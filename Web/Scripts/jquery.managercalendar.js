...
(function ($) {
    ...
    $.widget("ui.weekCalendar", {
        ...
        _setupEventCreationForWeekDay: function ($weekDay) {
            ...
            $weekDay.mousedown(function (event) {
                ...
                if ($newEvent.length) {
                    ...
                    $newEvent.remove();
                    var newCalEvent = { start: eventDuration.start, end: eventDuration.end, title: options.newEventText }; //, map: options.newEventText
        ...
        */
        _renderEvent: function (calEvent, $weekDay) {
            ...
            eventHtml = "<div class=\"" + eventClass + " ui-corner-all\">\
                ...
                <div class=\"wc-title\"></div></div>"; //<div class=\"wc-map\"></div>
        ...
        */
        _refreshEventDetails: function (calEvent, $calEvent) {
            ...
            // hieu's map
            //$calEvent.find(".wc-map").html(calEvent.map);
    ...
    $.extend($.ui.weekCalendar, {
        ...
        defaults: {
            ...
            shortMonths: ['Jan', 'Feb', 'Mar', 'Apr', '05', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
            longMonths: ['January', 'February', 'March', 'April', '05', 'June', 'July', 'August', 'September', 'October', 'November', 'December'],
